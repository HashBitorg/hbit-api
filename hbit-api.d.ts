...
declare module Hbit {
    ...
    interface ISendMessage extends IRecipient, ISecretPhrase, IPublicKey, IFeeDQT, IDeadline, IReferencedTransaction, IBroadcast, IMessageEncryptToSelf, IEncryptedMessageToSelf, IRecipientPublicKey {
    }
    interface ISendMoney extends IRecipient, ISecretPhrase, IPublicKey, IFeeDQT, IDeadline, IReferencedTransaction, IBroadcast, IMessageEncryptToSelf, IEncryptedMessageToSelf, IRecipientPublicKey {
        amountDQT: number;
    }
    interface IDeadline {
        deadline: number;
    ...
    interface ILeaseBalance extends IRecipient, ISecretPhrase, IPublicKey, IFeeDQT, IDeadline, IReferencedTransaction, IBroadcast, IMessageEncryptToSelf, IEncryptedMessageToSelf, IRecipientPublicKey {
        period: number;
    }
    ...
    interface ITransferAsset extends IRecipient, IAsset, IQuantityQNT, ISecretPhrase, IPublicKey, IFeeDQT, IDeadline, IReferencedTransaction, IBroadcast, IMessageEncryptToSelf, IEncryptedMessageToSelf, IRecipientPublicKey {
        comment?: string;
    }
    interface IAssets {
        assets: number;
    ...
    interface IPlaceOrder extends IAsset, ISecretPhrase, IPublicKey, IFeeDQT, IQuantityQNT, IDeadline, IReferencedTransaction, IBroadcast, IMessageEncryptToSelf, IEncryptedMessageToSelf, IRecipientPublicKey, IPriceDQT {
    }
    interface IPlaceBidOrder extends IPlaceOrder {
    }
    interface IPlaceAskOrder extends IPlaceOrder {
    }
    interface IIssueAsset extends ISecretPhrase, IPublicKey, IFeeDQT, IQuantityQNT, IDeadline, IReferencedTransaction, IBroadcast, IMessageEncryptToSelf, IEncryptedMessageToSelf, IRecipientPublicKey {
        name: string;
        description: string;
        decimals: number;
    }
    ...
    interface IAccountInfo extends ISecretPhrase, IPublicKey, IFeeDQT, IDeadline, IReferencedTransaction, IBroadcast, IMessageEncryptToSelf, IEncryptedMessageToSelf, IRecipientPublicKey {
        name: string;
        description: string;
    }
    ...
    interface IBuyAlias extends IAlias, ISecretPhrase, IPublicKey, IFeeDQT, IDeadline, IBroadcast, IReferencedTransaction, IEncryptedMessageToSelf, IMessageEncryptToSelf, IRecipientPublicKey {
    }
    interface ISetAlias extends ISecretPhrase, IPublicKey, IFeeDQT, IDeadline, IReferencedTransaction, IBroadcast, IEncryptedMessageToSelf, IMessageEncryptToSelf, IRecipientPublicKey {
        aliasName: string;
        aliasURI: string;
    }
    interface ISellAlias extends IAlias, IRecipient, IPriceDQT, ISecretPhrase, IPublicKey, IFeeDQT, IDeadline, IReferencedTransaction, IBroadcast, IMessageEncryptToSelf, IEncryptedMessageToSelf, IRecipientPublicKey {
    }
    ...
    interface ICancelOrder extends IOrder, ISecretPhrase, IPublicKey, IFeeDQT, IDeadline, IReferencedTransaction, IBroadcast, IMessageEncryptToSelf, IEncryptedMessageToSelf, IRecipientPublicKey {
    }
    ...
    interface IPollCast extends IPoll, ISecretPhrase, IPublicKey, IFeeDQT, IDeadline, IReferencedTransaction, IBroadcast, IMessageEncryptToSelf, IEncryptedMessageToSelf, IRecipientPublicKey {
        vote1?: any;
        vote2?: any;
        vote3?: any;
    }
    interface ICreatePoll extends ISecretPhrase, IPublicKey, IFeeDQT, IDeadline, IReferencedTransaction, IBroadcast, IMessageEncryptToSelf, IEncryptedMessageToSelf, IRecipientPublicKey {
        name: string;
        description: string;
    ...
    interface IDGSBase extends ISecretPhrase, IPublicKey, IFeeDQT, IDeadline, IReferencedTransaction, IBroadcast, IMessageEncryptToSelf, IEncryptedMessageToSelf, IRecipientPublicKey {
    }
    interface IDGSGoods {
        goods: any;
    }
    ...
    interface IDGSList extends IDGSBase, IPriceDQT {
        name: string;
        description: string;
        tags: any;
        quantity: number;
    ...
    interface IDGSPriceChange extends IDGSBase, IDGSGoods, IPriceDQT {
    }
    interface IDGSSetPurchase extends IDGSBase, IDGSGoods, IPriceDQT {
        quantity: number;
    ...
    class API {
        ...
        */
        ...
        public getBlocks(req: IBlock): Promise<IResponse>;
        public getBlocks(req: IBlock, callback: ICallback): void;
        ...
        public getBlockchainTransactions(): Promise<IResponse>;
        public getBlockchainTransactions(req: IRequest): Promise<IResponse>;
        public getBlockchainTransactions(req: IRequest, callback: ICallback): void;
