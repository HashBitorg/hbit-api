...
module Hbit {
    ...
    export class API {
        ...
        getBlocks(req: IBlock): Promise<IResponse>;
        getBlocks(req: IBlock, callback: ICallback): void;
        getBlocks(req: IBlock, callback?: ICallback): any {
        ...
        getBlockchainTransactions(): Promise<IResponse>;
        getBlockchainTransactions(req: IRequest): Promise<IResponse>;
        getBlockchainTransactions(req: IRequest, callback: ICallback): void;
        getBlockchainTransactions(req?: IRequest, callback?: ICallback): any {
            return this._call('getBlockchainTransactions', req, callback);
        }
